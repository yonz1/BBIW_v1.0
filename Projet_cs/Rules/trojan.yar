...
rule CVE_2023_21768 {
	...
	strings:
		$GetNtFunctions = "_NtCreateFile = (unsigned long(__stdcall*)(PHANDLE, unsigned long, POBJECT_ATTRIBUTES, PIO_STATUS_BLOCK, PLARGE_INTEGER, unsigned long, unsigned long, unsigned long, unsigned long, void*, unsigned long))GetProcAddress(GetModuleHandleA('ntdll.dll'), 'NtCreateFile');" 
		$GetNtFunctions1 = "_NtDeviceIoControlFile = (unsigned long(__stdcall*)(HANDLE, void*, void*, void*, PIO_STATUS_BLOCK, unsigned long, void*, unsigned long, void*, unsigned long))GetProcAddress(GetModuleHandleA('ntdll.dll'), 'NtDeviceIoControlFile');"  
		$GetNtFunctions2 = "_NtCreateIoCompletion = (unsigned long(__stdcall*)(PHANDLE, unsigned long, POBJECT_ATTRIBUTES, unsigned long))GetProcAddress(GetModuleHandleA('ntdll.dll'), 'NtCreateIoCompletion');" 
		$GetNtFunctions3 = "_NtSetIoCompletion = (unsigned long(__stdcall*)(HANDLE, unsigned long, PIO_STATUS_BLOCK, NTSTATUS, unsigned long))GetProcAddress(GetModuleHandleA('ntdll.dll'), 'NtSetIoCompletion');" 
		$GetNtFunctions4 = "_NtQuerySystemInformation = (unsigned long(__stdcall*)(SYSTEM_INFORMATION_CLASS, PVOID, ULONG, PULONG))GetProcAddress(GetModuleHandleA('ntdll.dll'), 'NtQuerySystemInformation');" 
		$Socket = "0x00, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x1E, 0x00, 0x41, 0x66, 0x64, 0x4F, 0x70, 0x65, 0x6E, 0x50,0x61, 0x63, 0x6B, 0x65, 0x74, 0x58, 0x58, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,0x00, 0x00, 0x00, 0x00, 0x60, 0xEF, 0x3D, 0x47, 0xFE" 
		...
		$Data1 = "Data.hCompletion = hCompletion;" 
    	$Data2 = "Data.pData1 = VirtualAlloc(NULL, 0x2000, MEM_RESERVE | MEM_COMMIT, PAGE_READWRITE);" 
    	$Data3 = "Data.pData2 = VirtualAlloc(NULL, 0x2000, MEM_RESERVE | MEM_COMMIT, PAGE_READWRITE);" 
    	$Data4 = "Data.dwCounter = 0x1;" 
    	$Data5 = "Data.dwLen = 0x1;" 
    	$Data6 = "Data.dwTimeout = 100000000;" 
    	$Data = "Data.pPwnPtr = pPwnPtr;" 
		$Control = "_NtDeviceIoControlFile(hSocket, hEvent, NULL, NULL, &IoStatusBlock, AFD_NOTIFYSOCK_IOCTL, &Data, 0x30, NULL, 0);" 
	condition:
		all of them 
}
